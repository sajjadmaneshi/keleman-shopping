...
import { SuggestionSliderItemComponent } from '../../../app/layout/pages/magazine/components/list/suggestion/suggestion-slider-item/suggestion-slider-item.component';
import { KelemanProductSwiperItemComponent } from './keleman-product-swiper-item/keleman-product-swiper-item.component';
