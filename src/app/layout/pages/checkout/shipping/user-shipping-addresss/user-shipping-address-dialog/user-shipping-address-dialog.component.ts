...
@Component({
  selector: 'keleman-user-shipping-address-dialog',

  templateUrl: './user-shipping-address-dialog.component.html',
  styleUrl: './user-shipping-address-dialog.component.scss',
})
export class UserShippingAddressDialogComponent implements OnDestroy {
